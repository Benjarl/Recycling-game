...
namespace LabData
{
    public class LabTools
    {
        ...
        public static T GetConfig<T>(bool isNew=false) where T : class,new()
       {
        ...
        /// </summary>
        /// <typeparam name="T"></typeparam>
        public static void CreateDataFolder<T>() where T:LabDataBase
        {
            var path = DataPath + "/" + typeof(T).Name;
            if (!Directory.Exists(path))
            {
                Directory.CreateDirectory(path);
            }
        ...
        /// <returns></returns>
        public static void WriteData<T>(T t,string dataName,bool isOverWrite=false) where T : LabDataBase, new()
        {
            var path = DataPath + "/" + typeof(T).Name+ "/" + dataName + ".json";
        ...
        /// <param name="dataName"></param>
        /// <returns></returns>
        public static T GetData<T>(string dataName) where T : LabDataBase
        {
            var path = DataPath + "/" + typeof(T).Name + "/" + dataName + ".json";
        ...
        /// <returns></returns>
        public static List<string> GetDataName<T>(bool isGetName = false) where T : LabDataBase
        {
            var path = DataPath + "/" + typeof(T).Name;
            if (Directory.Exists(path))
            {
